...
EOT
    ...
    yay -S kitty rofi ranger polybar gotop sh picom neovim lxappearance flameshot feh zsh fd zathura mpd codium bitwarden dunst xsettingsd pulseaudio zathura-pdf-mupdf spotify
